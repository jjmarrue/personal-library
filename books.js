class Book {
  constructor(title, pubYear, author, pages, readVal, genre) {
    this.title = title,
...
const librayApp = (function() {
  ...
  // determine if checkbox is checked then assign that value to object property
  ...
  // Get the string from localStorage and convert to valid object or use the provided library
